...
import { Text, ImageBackground, View, StyleSheet, BackHandler, Pressable, TextInput } from 'react-native'
...
const PrimeiraPagina = function () {
  ...
  return (
    <View style={styles.container}>
      <ImageBackground source={{uri: "https://i.pinimg.com/736x/97/54/ff/9754ffca5d5b86d2cf31e662b10e37ce.jpg"}} resizeMode="cover" 
        style={{height: '100%', width: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', opacity: 0.9}}>
